...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Thì ra tim tôi đang đập " + (thePercent+899) + " là vì em";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Aiss Toi Qua Yeu Em:';
document.querySelector('.Description .modal-body').innerHTML = 'Toi Yêu Em!!! <i class="fas fa-heart"></i> ';
